"""Question 4 entry point, delegates to the shared material-coordinate engine."""
...
def solve(name,**kwargs):return shared_solve(ROOT,4,name,**kwargs)

if __name__=='__main__':cli(ROOT,4)
