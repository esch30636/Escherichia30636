...
def main():
    ...
    (ROOT/'verification/summary.json').write_text(json.dumps(summary,indent=2,ensure_ascii=False), encoding='utf-8')
    ...
    (ROOT/'verification/sensitivity.json').write_text(json.dumps(sens,indent=2,ensure_ascii=False), encoding='utf-8')
