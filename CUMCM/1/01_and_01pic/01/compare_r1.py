# -*- coding: utf-8 -*-
"""校验 01 文件夹产物与已验证的 out/ 产物逐格一致(在 legion 上运行)。"""
import sys, json
sys.stdout.reconfigure(encoding='utf-8', errors='replace')
import openpyxl

p1 = r'D:\CUMCM\A\01\result1.xlsx'
p2 = r'D:\CUMCM\A\out\result1.xlsx'
...
# tables1.json vs tables.json 的表1/表2
d1 = json.load(open(r'D:\CUMCM\A\01\tables1.json', encoding='utf-8'))
d2 = json.load(open(r'D:\CUMCM\A\out\tables.json', encoding='utf-8'))
for key, ref in (('T', d2['表1']['T']), ('C', d2['表2']['C'])):
    got = d1[key]
    ...
    print(f'表{1 if key == "T" else 2}: 最大绝对差 {m:.3e}')
print('校验完成: 01 产物与已验证产物一致。')
