...
按附录 2，第一问全部物性参数如表~\ref{tab:params} 所示，无任何待定参数；
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\textwidth]{1/01_and_01pic/01-pic/fig01_chamber.png}
...
保留。表面采用串联热阻精确闭性：单元中心到表面的半单元导热与对流传热串联，
\begin{equation}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.72\textwidth]{1/01_and_01pic/01-pic/fig02_temp_map.png}
  \includegraphics[width=0.72\textwidth]{1/01_and_01pic/01-pic/fig03_moist_map.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{1/01_and_01pic/01-pic/fig04_timeseries.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.72\textwidth]{1/01_and_01pic/01-pic/fig06_convergence.png}
  \includegraphics[width=0.72\textwidth]{1/01_and_01pic/01-pic/fig07_conservation.png}
